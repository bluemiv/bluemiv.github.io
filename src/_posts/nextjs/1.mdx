...
updatedAt: 2025-01-07T20:13:19+09:00
...
우연히 FSD(`Feature-Sliced Design`)라는 아키텍처를 알게 되었고, 이 아키텍처를 사용하여 블로그를 개발해봤습니다. 솔직히 처음 사용해보는 패턴이라 개발할 때, 어느 위치에 어떤 파일 혹은 컴포넌트를 두어야할지 고민이 많았습니다. (자세한 내용은 추후 포스팅을 해볼 예정)
