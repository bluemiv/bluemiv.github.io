...
const appName = LOTTOCAT645_APP.name;
...
const pageUrl = `${SITE_METADATA.baseUrl}${ROUTE_PATH.APPS_LOTTOCAT645_PRIVACY}`;
const appIcon = LOTTOCAT645_APP.icon;
...
export default function Lottocat645PrivacyPage() {
  return (
