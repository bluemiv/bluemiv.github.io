    ...
    <main>
      <div className="mx-auto max-w-[1280px] w-full flex flex-col gap-md leading-8">
        ...
        <p>
          ...
          における個人情報の取扱いを説明するものです。{appName} は成人（18歳以上）向けの AI
          キャラクターチャットサービスであり、当社はサービス提供・安全運用に必要な範囲で個人情報を処理します。
        </p>
        <p>
          サイト:{' '}
        ...
        <PrivacySection title="第9条（未成年者）">
          <p>
            {appName} は18歳以上向けサービスです。未成年者による利用が確認された場合、法令および
            ポリシーに基づきアカウント制限または削除を行うことがあります。
          </p>
        </PrivacySection>
