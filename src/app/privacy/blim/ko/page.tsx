    ...
    <main>
      <div className="mx-auto max-w-[1280px] w-full flex flex-col gap-md leading-8">
        ...
        <p>
          ...
          개인정보를 어떻게 처리하는지 설명합니다. {appName}은 성인(18+) 대상 AI 캐릭터 채팅
          서비스이며, 회사는 서비스 제공·보안·운영에 필요한 범위에서만 개인정보를 처리합니다.
        </p>
        <p>
          사이트 주소:{' '}
        ...
        <PrivacySection title="제9조(아동의 개인정보 보호)">
          <p>
            {appName}은 만 18세 이상 성인 대상 서비스입니다. 미성년자 이용이 확인되는 경우 관련 법령
            및 정책에 따라 계정 제한 또는 삭제 조치를 할 수 있습니다.
          </p>
        </PrivacySection>
