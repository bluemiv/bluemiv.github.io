      ...
      <div className="mx-auto max-w-[1280px] w-full flex flex-col gap-md leading-8">
          ...
          <PrivacyList
            ...
            items={[
              ...
              },
              {
                ...
                text: '맞춤형 광고 노출(AdMob), 부정 클릭 방지, 앱 사용성 분석(GA4) 및 서비스 품질 개선',
              },
            ]}
          />
                ...
                children: [
                  {
                    ...
                    text: '광고 노출/클릭, 화면 조회, 버튼 클릭 등 앱 내 이벤트 로그',
                  },
                  {
                    title: '기기·앱 정보',
                    text: '운영체제 종류/버전, 단말기 모델, 앱 버전 등(분석/광고 SDK 자동 수집 가능)',
                  },
                ],
                extra: (
        ...
        <PrivacySection title="제3조(보유 및 이용 기간)">
          <PrivacyList
            ...
            items={[
              {
                text: '로또켓645는 별도 서버를 통해 이용자 식별정보를 장기간 저장하지 않습니다. 광고·분석 목적 데이터는 각 SDK 제공자의 보관기간 설정 및 정책에 따릅니다.',
              },
              {
                title: 'GA4 보관기간',
                text: '관리자가 2개월 또는 14개월 중 선택할 수 있으며, Google-signals 데이터는 설정과 무관하게 최대 26개월 보관될 수 있습니다.',
              },
              {
                title:
        ...
        <PrivacySection title="제6조(자동 수집 장치의 설치·운영 및 거부)">
          <PrivacyList
            ...
            items={[
              {
                title: '쿠키',
                text: '로또켓645는 모바일 앱 특성상 쿠키를 사용하지 않습니다.',
              },
              {
        ...
        <PrivacySection title="제13조(외부 서비스와의 연동)">
          <p>
            본 앱은 광고(AdMob) 및 분석(GA4)을 위해 Google LLC의 SDK를 사용할 수 있습니다. 해당
            사업자가 자체적으로 개인정보를 수집·처리하는 경우, 각 사업자의 처리방침이 적용되며
            자세한 내용은 해당 사업자의 정책을 확인하시기 바랍니다.
          </p>
        </PrivacySection>
