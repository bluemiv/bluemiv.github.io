    ...
    <main>
      <div className="mx-auto max-w-[1280px] w-full flex flex-col gap-md leading-8">
        ...
        <PrivacySection title="제1조(처리 목적)">
          <p>
            로또켓645는 다음의 목적을 위하여 최소한의 개인정보를 처리합니다. 명시된 목적 외의 용도로는
            ...
            items={[
              {
                title: '콘텐츠 제공',
                text:
                  '로또 6/45 회차별 당첨 번호 조회, 번호 추천(스마트/가중치/역가중치), 통계 분석, 생성 내역 및 즐겨찾기 기능 제공',
              },
              {
          ...
          <PrivacyList
            ...
            items={[
              ...
              },
              {
                title: '수집하지 않는 항목',
                text:
                  '이름, 연락처, 위치정보 등 직접 식별 가능한 개인정보는 앱 차원에서 수집하지 않습니다.',
              },
            ]}
          />
        </PrivacySection>
        ...
        <PrivacySection title="제3조(보유 및 이용 기간)">
          <PrivacyList
            ...
            items={[
              {
                text:
                  '로또켓645는 별도 서버를 통해 이용자 식별정보를 장기간 저장하지 않습니다. 광고 운영 목적 데이터는 Google LLC(AdMob)의 보관기간 설정 및 정책에 따릅니다.',
              },
              {
                title:
        ...
        <PrivacySection title="제4조(개인정보의 제3자 제공)">
          로또켓645는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 법령에 근거가
        ...
        <PrivacySection title="제5조(처리 위탁 및 국외 이전)">
          <PrivacyList
            ...
            items={[
              {
                text:
                  '안정적 서비스 제공을 위해 개인정보 처리 업무의 일부를 외부에 위탁하며, 수탁자가 국외에 위치한 경우 국외 이전이 발생할 수 있습니다. 위탁계약 체결 시 개인정보 보호 관련 법령을 준수합니다.',
                children: [
                  ...
                  { title: '이전 일시 및 방법', text: '앱 사용 시점마다 네트워크를 통한 실시간 전송' },
                  {
                    title: '이전 항목',
                    text:
                      '광고 식별자(AAID/IDFA), 광고 이벤트 로그(노출/클릭 등), 기기·앱 정보(운영체제, 단말기 모델, 앱 버전 등)',
                  },
            ...
            items={[
              { title: '쿠키', text: '로또켓645는 모바일 앱 특성상 쿠키를 사용하지 않습니다.' },
              {
                ...
                children: [
                  ...
                  {
                    text:
                      '(iOS의 경우에도 설정에서 추적 허용 여부를 관리할 수 있습니다.) 설정 변경 시 맞춤형 광고가 제한되거나 식별자가 재설정/삭제될 수 있습니다.',
                  },
                ],
              },
            ]}
        ...
        <PrivacySection title="제8조(개인정보의 안전성 확보 조치)">
          로또켓645는 「개인정보의 안전성 확보조치 기준」을 준수하기 위해 다음과 같은 조치를 취합니다.
          <PrivacyList
            items={[
              {
                text:
                  '내부관리계획 수립·시행, 접근권한 관리, 접속기록 보관 및 위·변조 방지, 암호화 적용(가능한 경우), 악성코드 방지 및 보안 프로그램 적용, 정기 점검 및 교육 등',
              },
            ]}
          />
        </PrivacySection>
        ...
        <PrivacySection title="제9조(정보주체의 권리·의무 및 행사 방법)">
          <PrivacyList
            items={[
              {
                text:
                  '정보주체는 로또켓645에 대해 언제든지 열람·정정·삭제·처리정지 요구 등을 행사할 수 있습니다. 대리인을 통한 행사도 가능합니다(별지 제11호 서식 위임장).',
              },
              {
                text:
                  '권리 행사는 서면, 이메일, 팩스 등으로 신청하실 수 있으며, 로또켓645는 지체 없이 조치합니다.',
              },
              {
                text:
        ...
        <PrivacySection title="제12조(데이터 출처 및 고지)">
          <p className="mb-sm">
            본 앱은 <strong>동행복권</strong>에서 공개하는 자료(예: 회차별 당첨 번호)를 바탕으로 정보를
            제공합니다. 공식 발표와 앱 표시 간 지연·오차가 발생할 수 있으며, 상이한 경우{' '}
