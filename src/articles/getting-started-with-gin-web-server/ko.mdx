---
id: article-013
slug: getting-started-with-gin-web-server
locale: ko
category: backend
topics: ['go']
legacyPaths:
...
publishedAt: 2025-04-08T23:13:25+09:00
modifiedAt: 2025-04-08T23:13:25+09:00
tags: ['gin', 'api', 'web-server']
isPublished: true
coverImage: /r/i/go/13/thumbnail.webp
---
...
우선 Go가 설치되어 있어야 합니다. Go 설치 방법은 [Mac에 Go 설치하기](/articles/install-go-on-macos-with-homebrew/#2-macosx에서-설치-방법) 문서를 참고하세요.
