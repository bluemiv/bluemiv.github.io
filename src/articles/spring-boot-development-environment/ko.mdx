---
id: article-029
slug: spring-boot-development-environment
locale: ko
category: backend
topics: ['spring', 'java']
legacyPaths:
...
publishedAt: 2025-08-05T09:45:32+09:00
modifiedAt: 2025-08-05T09:45:32+09:00
tags: ['spring', 'springboot', 'java', 'gradle', 'maven', 'setup']
isPublished: true
coverImage: /r/i/spring/29/thumbnail.webp
---
...
생성된 프로젝트 구조는 다음과 같습니다. 각 폴더와 파일의 역할은 [Spring Boot 프로젝트 구조 이해하기](/articles/spring-boot-project-structure/)에서 더 자세히 정리했습니다.
...
설정 파일을 더 깊게 이해하고 싶다면 [application.yml과 application.properties 설정](/articles/spring-boot-application-configuration/)을 같이 참고해주세요.
