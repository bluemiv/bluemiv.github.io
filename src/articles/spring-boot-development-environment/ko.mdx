...
생성된 프로젝트 구조는 다음과 같습니다. 각 폴더와 파일의 역할은 [Spring Boot 프로젝트 구조 이해하기](/blog/spring/31)에서 더 자세히 정리했습니다.
...
설정 파일을 더 깊게 이해하고 싶다면 [application.yml과 application.properties 설정](/blog/spring/32)을 같이 참고해주세요.
