---
id: article-033
slug: spring-ioc-and-dependency-injection
locale: ko
category: backend
topics: ['spring', 'java']
legacyPaths:
...
publishedAt: 2025-08-15T11:27:41+09:00
modifiedAt: 2025-08-15T11:27:41+09:00
tags: ['spring', 'springboot', 'java', 'ioc', 'di', 'dependency-injection']
isPublished: true
coverImage: /r/i/spring/33/thumbnail.webp
---

## 1. IoC와 DI가 왜 필요할까?

Spring을 공부하다 보면 `IoC`, `DI`라는 용어를 자주 보게 됩니다. 아직 Spring과 Spring Boot의 차이가 헷갈린다면 [Spring vs Spring Boot 차이점](/articles/spring-vs-spring-boot/)을 먼저 보고 오면 좋습니다.
...
Spring Boot 애플리케이션이 실행되면 Spring은 컴포넌트 스캔을 통해 이런 클래스를 찾고, 객체를 생성해서 컨테이너에 등록합니다. 컴포넌트 스캔이 시작되는 메인 클래스 위치는 [Spring Boot 프로젝트 구조 이해하기](/articles/spring-boot-project-structure/)에서 설명한 패키지 구조와도 연결됩니다.
