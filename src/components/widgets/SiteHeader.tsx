  ...
  return (
    <header className="border-border bg-canvas/80 sticky top-0 z-50 border-b backdrop-blur-xl">
      ...
      <div
        ...
        className={`border-border bg-canvas/88 absolute inset-x-0 top-full border-b backdrop-blur-xl transition-[opacity,transform,visibility] duration-200 ease-out motion-reduce:transition-none md:hidden ${
          isMobileMenuOpen
