...
description: 환경 변수의 개념과 Next.js에서 클라이언트와 서버 변수를 구분해 선언하는 방법을 정리합니다.
publishedAt: 2025-04-28T21:32:48+09:00
modifiedAt: 2025-04-28T21:32:48+09:00
tags: ['nextjs', 'environment-variables', 'frontend']
isPublished: true
