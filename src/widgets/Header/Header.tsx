import { Home, NotebookText, Smartphone, UserRound } from 'lucide-react';
      ...
      <nav className="w-full h-full mx-auto flex items-center justify-between gap-md">
        ...
        <ul className="flex flex-1 items-center justify-end gap-[2px] sm:gap-xs">
          {[
            ...
            { href: ROUTE_PATH.APPS, label: 'APPS', Icon: Smartphone },
            {
            ...
            <li key={href}>
              <NavLink
                ...
                className="h-10 w-10 px-0 lg:w-auto lg:px-sm"
                href={href}
                title={label}
              >
