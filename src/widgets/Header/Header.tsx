...
export default function Header() {
  return (
    <header className="w-full px-md h-[50px] sticky inset-0 z-10 bg-white/80 dark:bg-app-dark-bg/20 backdrop-blur-sm border-b border-app-sub-bg dark:border-app-dark-sub-bg">
