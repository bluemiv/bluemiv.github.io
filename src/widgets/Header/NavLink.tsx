...
export default function NavLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        'motion-chip hover:bg-app-primary-soft dark:hover:bg-app-dark-primary-soft hover:text-app-primary dark:hover:text-app-dark-primary rounded-full transition duration-150 ease-in-out flex shrink-0 items-center justify-center gap-xs whitespace-nowrap text-sm font-semibold text-app-text-muted dark:text-app-dark-text-muted',
        className,
      )}
      href={href}
      title={title}
